...
public class WiggleSubsequence {
    ...
    public static void main(String[] args) throws InvocationTargetException, IllegalAccessException {
        ...
        param.add(new int[]{1, 7, 4, 9, 2, 5});
        params.add(param);

        param = new ArrayList<>();
        param.add(new int[]{1, 2, 3, 4, 5, 6, 7, 8, 9});
        params.add(param);

        param = new ArrayList<>();
        param.add(new int[]{1, 17, 5, 10, 13, 15, 10, 5, 16, 8});
        params.add(param);

        param = new ArrayList<>();
        param.add(new int[]{33, 53, 12, 64, 50, 41, 45, 21, 97, 35, 47, 92, 39, 0, 93, 55, 40, 46, 69, 42, 6, 95, 51
        ...
        Utils.testStaticMethod(WiggleSubsequence.class, params);
    }
}
