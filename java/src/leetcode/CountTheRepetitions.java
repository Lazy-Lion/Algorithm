...
public class CountTheRepetitions {
     ...
     *   len1 = s1.length()
     */
    public static int getMaxRepetitions_2(String s1, int n1, String s2, int n2) {
    ...
    public static void main(String[] args) throws InvocationTargetException, IllegalAccessException {
        Utils.testStaticMethod(CountTheRepetitions.class
                , new HashSet<String>() {
                    {
                        add("getMaxRepetitions");
                        add("getMaxRepetitions_2");
                    }
                }, Arrays.asList(
                        Arrays.asList("acb", 4, "ab", 2),
                        Arrays.asList("aaa", 3, "aa", 1),
                        Arrays.asList("niconiconi", 99981, "nico", 81),
                        Arrays.asList("ecbafedcba", 3, "abcdef", 1),
                        Arrays.asList("lovelive", 0, "lovelive", 10)
                ));
    }
}
