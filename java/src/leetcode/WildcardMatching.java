...
public class WildcardMatching {
    ...
    public static void main(String[] args) throws InvocationTargetException, IllegalAccessException {
        Utils.testStaticMethod(WildcardMatching.class
                , new HashSet<String>() {
                    {
                        add("isMatch");
                        add("isMatch_2");
                ...
                , Arrays.asList(
                        ...
                        Arrays.asList("aa", "*"),
                        Arrays.asList("cb", "?a"),
                        Arrays.asList("adceb", "a*b"),
                        Arrays.asList("acdcb", "a*c?b"),
                        Arrays.asList("aaaa", "**a"),
                        Arrays.asList("", "*"),
                        Arrays.asList("bbbababbbbabbbbababbaaabbaababbbaabbbaaaabbbaaaabb", "*b********bb*b*bbbbb*ba")
                ));
    }
}
