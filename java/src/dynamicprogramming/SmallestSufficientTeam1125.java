...
public class SmallestSufficientTeam1125 {
	...
	public static void main(String[] args) {
		...
		List<List<String>> people = new ArrayList<>(Arrays.asList(
				new ArrayList<>(Arrays.asList("java")),
				new ArrayList<>(Arrays.asList("nodejs")),
				new ArrayList<>(Arrays.asList("nodejs", "reactjs"))));
		...
		people = new ArrayList<>(Arrays.asList(
				new ArrayList<>(Arrays.asList("algorithms","math","java")),
				new ArrayList<>(Arrays.asList("algorithms","math","reactjs")),
				new ArrayList<>(Arrays.asList("java","csharp","aws")),
				new ArrayList<>(Arrays.asList("reactjs","csharp")),
				new ArrayList<>(Arrays.asList("csharp","math")),
				new ArrayList<>(Arrays.asList("aws","java"))));
		System.out.println(Arrays.toString(smallestSufficientTeam(req_skills, people)));
	}
}
